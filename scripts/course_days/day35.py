...
```
GET  /expansion-config  ◄── store.get_citation_config()
...
def _file22() -> str:
    return f"""# Day 36 精读：citation_builder 与多查询扩展管线
