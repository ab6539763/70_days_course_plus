...
「打开 answer_validator，找 validate。先看 enabled：关了直接放行。开则算 reply 与 citations 的 token 覆盖率，低于 min_score 且 refuse_on_fail 才拒答。这就是 {REQ} 的读取路径。」
...
「打开 answer_validator，ValidationResult 有 passed score reason。chat 里 validation 字段挂在 reply 后面。前端可展示校验是否通过。这就是 {REQ}。」

---

## 五十、End of 22 精读

**NexusAgent 课程 · Phase 3 · Day 37 · Validation · {REQ} · answer_validator 精读完**
"""
