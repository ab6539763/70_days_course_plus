...
- 上午少讲 npm，多动手改 CSS  
- 下午先 pytest 再浏览器，建立「CI 绿了再演示」习惯  
- 预留 15 分钟端口冲突答疑  

## 2. 常见学员问题标准答

**Q：要不要学 TypeScript？**  
A：Day 22 不要求；类型安全由 Day 23 Pydantic 在后端保障。

**Q：mock 百分比假的不违法吗？**  
A：演示环境 badge 写 Mock；生产接真实 score。

## 3. 无障碍抽检清单

讲师课前用 Chrome Lighthouse Accessibility 扫一遍，分数 > 90 为佳。

## 4. 与 Day 23 衔接话术

「今日 mock.js 的 sendMessageApi 就是明日 FastAPI 的客户端。你们已经写了一半全栈。」
...
| 投影无网 | 离线 http.server |
| pytest 失败 | 备用笔记本已绿分支 |
| 浏览器缓存旧 JS | Ctrl+Shift+R |

## 6. 推荐阅读

- WHATWG HTML Living Standard（节选）  
- 智链科技内部《前端无障碍基线 v1》  
