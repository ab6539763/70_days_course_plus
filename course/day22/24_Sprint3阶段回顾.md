# Sprint 3 阶段回顾（Day 15–22）

**日期锚点**：2026-07-27  
**范围**：Phase 2 Sprint 3 前八日
...
gantt
    ...
    Day19 RAG             :done, 2026-07-24, 1d
    Day20 Embedding       :done, 2026-07-25, 1d
    Day21 工具编排        :done, 2026-07-26, 1d
    Day22 静态前端        :done, 2026-07-27, 1d
    section 待完成
    Day23 FastAPI         :2026-07-28, 1d
    Day24 Web克隆         :2026-07-29, 1d
```
...
Day 15 问 token 是什么 → Day 21 讲工具 → Day 22 改 CSS 做演示。代表学员从后端思维到全栈视野。
...
- [ ] 能画 Day15→22 数据流  
- [ ] 能跑通 test_sprint3 + test_frontend  
- [ ] 能说明 handle_message 与 parseReply 关系  
