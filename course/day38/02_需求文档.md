...
- `day38/route_demo.py` 打印引用列表  
- `day38/route_api_demo.py` 演示 API  
- `tests/day38/` 20 项覆盖 builder、store、API、chat  
...
| FR | 实现位置 | 测试 |
|----|----------|------|
| FR-001 | validation_retry.RuleBasedQueryRouter.route | test_RuleBasedQueryRouter.route_from_results |
...
| FR-007 | day38/* | test_health_version |
...
```bash
pytest tests/day38/test_query_router.py -v
...
| 版本 | 变更 |
|------|------|
| v0.38.0-draft | 仅 QueryRouter |
| v0.38.0 | citation API + chat + 前端 + 20 tests |
