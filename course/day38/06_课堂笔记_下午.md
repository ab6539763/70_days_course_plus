...
**14:00–14:30** 第五节：day38/retry_demo.py 现场
**14:30–15:20** 第六节：apply_validation_retry 源码走读
...
课堂上逐行读 `apply_validation_retry`，重点讲输入输出与 Day 37 管线的衔接点。
...
curl -s -X POST http://127.0.0.1:8000/api/knowledge/validation-retry-preview \
