...
```bash
python3 -c "import rag.validation_retry; print('ok')"
...
```bash
python3 src/day38/route_demo.py | tee /tmp/day37_demo.txt
```
...
```bash
python3 src/day38/route_api_demo.py
```

**通过标准**：citation-preview 200；chat citations ≥1；version v0.38.0。
