...
**14:00–14:30** 第五节：day35/expansion_demo.py 现场
**14:30–15:20** 第六节：ExpandingRetriever 源码走读
**15:20–16:00** 第七节：/api/knowledge/expansion-config API
...
课堂上逐行读 `ExpandingRetriever`，重点讲输入输出与 Day 34 管线的衔接点。
