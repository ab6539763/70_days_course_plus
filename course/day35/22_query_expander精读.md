...
`test_health_version` 锁版本 `v0.35.0`；`test_chat_includes_citations` 端到端。
...
读罢 22 精读，你应能**逐行**解释 `merge_retrieval_results` 与 `ExpandingRetriever.search`，并映射到 ZL-NA-REQ-035 的 FR-001–FR-003。
