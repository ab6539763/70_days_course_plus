...
curl -s -X POST http://127.0.0.1:8000/api/knowledge/validation-preview -H 'Content-Type: application/json' -d '{"query":"测试"}' | jq .
```
...
`lab/day37-<姓名>.md` 含 Lab 4 表格 + Lab 6 截图。
