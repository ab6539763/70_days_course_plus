...
**必读**：`test_RuleBasedAnswerValidator.route_from_results_candidates`、`test_citation_preview_with_rewrite`。
...
学员随机抽：讲解 `test_RuleBasedAnswerValidator.route_from_results_candidates` 如何构造噪声候选。
