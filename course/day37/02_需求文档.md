...
| FR | 实现位置 | 测试 |
|----|----------|------|
| FR-001 | citation_builder.RuleBasedAnswerValidator.route | test_RuleBasedAnswerValidator.route_from_results |
...
**新增**：AnswerValidator、RouteConfig、citation API、chat citations、前端展示  
