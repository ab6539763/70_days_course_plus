...
智链理财知识库经 Day31 hybrid 后，客服「查电话 / 查收益率」类 query 召回改善，但 LLM 上下文仅取 top-3，**排序**成为新瓶颈。ZL-NA-REQ-032 要求可开关、可调池的两阶段检索，默认 mock 交叉编码器便于 CI。
